...
function SoloParentTicketModule() {
  ...
  const data = [
    ...
    },
    {
      ...
      ticketType: 'Relief Distribution Application',
      status: 'On Process',
      result: 'Result here...',
      notes: 'This is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notesThis is just a sample notes'
    }
  ];  
